    ...
    new MaterialApp(
        ...
        theme: new ThemeData(
          textTheme: new TextTheme(
              body1: new TextStyle(fontSize: 18.0, color: Colors.black)),
          brightness: globals.useLightTheme ? Brightness.light : Brightness
              .dark,
        ...
        routes: <String, WidgetBuilder>{
          ...
          "/ActivityMonitor": (BuildContext context) =>
          new DefaultTabController(
              length: choices.length, child: new ActivityMonitor()),

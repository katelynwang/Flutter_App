      ...
      body: new Container(
        ...
        child: new Table( //TODO: horizontal view
          ...
          border: new TableBorder(
              ...
              bottom: new BorderSide(color: const Color(0x42000000), width: 1.0),
              left: new BorderSide(color: const Color(0x42000000), width: 1.0),
              right: new BorderSide(color: const Color(0x42000000), width: 1.0),
              verticalInside: new BorderSide(width: 1.0, color: const Color(0x42000000)),    //Colors.black45
              horizontalInside: new BorderSide(width: 1.0, color: const Color(0x61000000))
          ),
          ...
          children: <TableRow>[
            new TableRow(
                children: <Widget>[
                  new TableCell(child: new Text('  Ordered Tests', style: new TextStyle(height: 1.8))),
            ...
            new TableRow(
                children: <Widget>[
                  new TableCell(child: new Text('  CBC with Differential', style: new TextStyle(height: 1.5))),
            ...
            new TableRow(
                children: <Widget>[
                  new TableCell(child: new Text('  CRP (C-Reactive Protein)', style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('02/21/2018', textAlign: TextAlign.center, style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('13:33', textAlign: TextAlign.center, style: new TextStyle(height: 1.5)))
                ]
            ),
            new TableRow(
                children: <Widget>[
                  new TableCell(child: new Text('  Clotting Studies', style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('02/21/2018', textAlign: TextAlign.center, style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('13:33', textAlign: TextAlign.center, style: new TextStyle(height: 1.5)))
                ]
            ),
            new TableRow(
                children: <Widget>[
                  new TableCell(child: new Text('  Electrolytes', style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('02/21/2018', textAlign: TextAlign.center, style: new TextStyle(height: 1.5))),
                  new TableCell(child: new Text('13:33', textAlign: TextAlign.center, style: new TextStyle(height: 1.5)))
                ]
            )

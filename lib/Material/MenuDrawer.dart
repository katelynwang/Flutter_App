...
//    final List<Widget> funtionItems = <Widget>[
    return new ListView(
      children: <Widget>[
        ...
        new ListTile(
          title: new Text(
              'Current State', textScaleFactor: globals.textScaleFactor,
...
//              .withOpacity(0.025),
        ...
        new ListTile(
          title: new Text(
              'Activity Monitor', textScaleFactor: globals.textScaleFactor,
              style: const TextStyle(color: Colors.black)),
          onTap: () {
            Navigator.of(context).pop();
        ...
        new ExpansionTile(
          title: new Text(
              'Risk Hisotry', textScaleFactor: globals.textScaleFactor,
              style: new TextStyle(
                  fontSize: 14.0,
                  fontWeight: FontWeight.w500,
                  color: Colors.black)),
          ...
          children: <Widget>[
            ...
            new ListTile(
              title: new Text(
                  '    Hypoglycemia', textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
        ...
        new ExpansionTile(
          ...
          children: <Widget>[
            new ListTile(
              title: new Text('    View Recommended Test',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('    Order Additional Test',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('    Enter Patient Report',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('    View Patient Report',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('Enter Recommended Medication',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
        ...
        new ExpansionTile(
          title: new Text(
              'PSSAT Form', textScaleFactor: globals.textScaleFactor,
              style: new TextStyle(
                  fontSize: 14.0,
                  fontWeight: FontWeight.w500,
                  color: Colors.black)),
          ...
          children: <Widget>[
            new ListTile(
              title: new Text('    PSSAT Form Direction',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text(
                  '    Time A', textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text(
                  '    Time B', textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text(
                  '    Time C', textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('    Specific Interventions',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();
            ...
            new ListTile(
              title: new Text('    Self Evaluation Questions',
                  textScaleFactor: globals.textScaleFactor,
                  style: const TextStyle(color: Colors.black)),
              onTap: () {
                Navigator.of(context).pop();

...
class PssatFormDir extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        title: new Text(
            "PSSAT Form Direction",
            textScaleFactor: globals.textScaleFactor,),
      ),

      body: new Container(
        padding: new EdgeInsets.only(top: 25.0, left: 15.0, right: 15.0),
        child: new Column(
          children: <Widget>[
            new Container(
              padding: new EdgeInsets.only(top: 10.0, left: 15.0, right: 15.0),
              child: new Text(
            ...
            new Container(
                ...
                child: new RaisedButton(
                  onPressed: () {Navigator.of(context).pushNamed('/PssatFormMenu');},
                  child: new Text(
                    'Continue',
                    textScaleFactor: globals.textScaleFactor,),
                )

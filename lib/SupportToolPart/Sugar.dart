      ...
      body: new Container(
        child: new MyListView(
          options: [
            ...
            new Option(new Icon(Icons.compare_arrows), 'Convertors', context,
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Option(
                new Icon(Icons.local_hospital), 'Risks & Treatment', context,
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Option(new Icon(Icons.disc_full), 'Quick Slides', context,
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Option(new Icon(Icons.card_membership), 'Quick Cards', context, new MaterialPageRoute(builder: (_) => new QuickCard())),
            new Option(new Icon(Icons.book), 'Educational Material', context,
                new MaterialPageRoute(builder: (_) => new Blank())),
          ],
        ),
      ),

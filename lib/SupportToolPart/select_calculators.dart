...
class CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(
            'Select Calculators', textScaleFactor: globals.textScaleFactor),
      ),
      ...
      body: new Container(
        child: new MyListView(
          options: [
            ...
            new Option(new Icon(Icons.confirmation_number), 'Bolus Calculator',
                context, new MaterialPageRoute(builder: (_) => new Blank())),

      ...
      body: new Container(
        child: new ModuleListView(
          modules: [
            ...
            new Module(new ImageIcon(assetImageAirway), 'Temperature',
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Module(new ImageIcon(assetImageAirway), 'Airway',
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Module(new ImageIcon(assetImageAirway), 'Blood Pressure',
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Module(new ImageIcon(assetImageAirway), 'Lab Work',
                new MaterialPageRoute(builder: (_) => new Blank())),
            new Module(new ImageIcon(assetImageAirway), 'Emotional Support',
